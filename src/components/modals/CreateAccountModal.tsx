...
export default function CreateAccountModal({ isOpen, onClose, userId }: CreateAccountModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-32px)] max-w-lg bg-factory-white rounded-2xl shadow-xl z-10 max-h-[90vh] overflow-y-auto scrollbar-thin">
